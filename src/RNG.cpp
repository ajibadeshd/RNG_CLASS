...
double MTFromPIMC::randBernouli( const double n){
	return random.randBernouli( n);};
...
//BERNOULI DIST TEST
double MTFromSTL::randBernouli( const double p_true){
	using parm_t = decltype(disBernouli)::param_type;
	return disBernouli( generator, parm_t{p_true});};
...
//BERNOULI DIST TEST
double MTFromPCG::randBernouli( const double p_true){
	using parm_t = decltype(disBernouli)::param_type;
	return disBernouli( generator, parm_t{p_true});};
...
double MTFromBOOST::randBernouli( const double p_true){
	using parm_t = decltype(disBernouli)::param_type;
	return disBernouli( generator, parm_t{p_true});
	};
